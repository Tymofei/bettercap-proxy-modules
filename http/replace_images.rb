...
=begin
BETTERCAP
Author : Simone 'evilsocket' Margaritelli, David Kotriksnov (SH4V) & s-aguado
...
class ReplaceImages < BetterCap::Proxy::HTTP::Module
  meta(
    ...
    def initialize
        ...
        raise BetterCap::Error, "No files found in the HTTPD path ( --httpd-path argument ) '#{opts.httpd_path}'" unless @imgArray.length > 0
